...
#need to import SGDClassifier from sklearn.linear_model
...
#to use np, We need to import numpy as np
...
for i in [0, 1, 2]:
    ...
    #need to change xs to Xs to make the plot; Xs and ys have the same dimension.
    plt.plot(Xs, ys)
    #need to delete hold = TRUE 
